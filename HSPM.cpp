/**********  
 *  [ Hospital Management CPP Project ]

*******************************

Hospital Management System implemented in C++,
utilizing various concepts of object-oriented programming (OOP). 
The system offers a range of features to effectively manage hospital operations and patient information.
